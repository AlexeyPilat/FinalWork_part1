...
## Задание 2. Создание алгоритма-схемы решения задачи
В папке Diagram находится скрин с изображением блок-схемы.
![блок-схема](./Diagram/DiagramTask.jpg)
...
Элементы для массива вводит пользователь и на этапе ввода идет проверка по условию "длина символов <= 3" и в случае соответствия, данный элемент добавляется в массив.